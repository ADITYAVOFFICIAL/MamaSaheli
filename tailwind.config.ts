	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				primary: {
					DEFAULT: 'hsl(var(--primary))', // Should map to mamasaheli.primary via CSS vars
					foreground: 'hsl(var(--primary-foreground))',
				},
				secondary: {
					DEFAULT: 'hsl(var(--secondary))', // Should map to mamasaheli.secondary via CSS vars
				...
				accent: {
					DEFAULT: 'hsl(var(--accent))', // Should map to mamasaheli.accent via CSS vars
				...
				// Your custom mamasaheli color palette
				mamasaheli: {
			...
			typography: ({ theme }) => ({
				DEFAULT: { // Base 'prose' styles (light mode)
					css: {
						...
						// Headings color
						'--tw-prose-headings': theme('colors.mamasaheli.primary'),
						'--tw-prose-lead': theme('colors.gray[600]'),
						// Links color
						'--tw-prose-links': theme('colors.mamasaheli.secondary'),
						// Bold text color
						'--tw-prose-bold': theme('colors.mamasaheli.dark'),
						// List counters and bullets color
						'--tw-prose-counters': theme('colors.mamasaheli.primary'),
						'--tw-prose-bullets': theme('colors.mamasaheli.primary'),
						// Horizontal rule color
						'--tw-prose-hr': theme('colors.gray[200]'),
						// Blockquote text and border color
						'--tw-prose-quotes': theme('colors.mamasaheli.dark'),
						'--tw-prose-quote-borders': theme('colors.mamasaheli.primary'),
						// Captions color
						'--tw-prose-captions': theme('colors.gray[500]'),
						// Inline code text color
						'--tw-prose-code': theme('colors.mamasaheli.accent'),
						...
						// Link hover color
						'a:hover': {
							color: theme('colors.mamasaheli.accent'), // Pink hover for links
						},
				...
				invert: {
					css: {
						...
						'--tw-prose-headings': theme('colors.mamasaheli.light'), // Light purple headings
						'--tw-prose-lead': theme('colors.gray[400]'),
						'--tw-prose-links': theme('colors.mamasaheli.secondary'), // Keep blue links? Or adjust
						'--tw-prose-bold': theme('colors.white'),
						'--tw-prose-counters': theme('colors.mamasaheli.light'),
						'--tw-prose-bullets': theme('colors.mamasaheli.light'),
						'--tw-prose-hr': theme('colors.gray[700]'),
						'--tw-prose-quotes': theme('colors.gray[100]'),
						'--tw-prose-quote-borders': theme('colors.mamasaheli.light'),
						'--tw-prose-captions': theme('colors.gray[400]'),
						'--tw-prose-code': theme('colors.mamasaheli.accent'), // Keep pink inline code
						...
						'a:hover': {
							color: theme('colors.mamasaheli.accent'), // Keep pink hover?
						},
						'img': {
