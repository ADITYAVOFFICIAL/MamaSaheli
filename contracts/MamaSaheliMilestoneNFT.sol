...
/**
 * @title MamaSaheli Milestone NFT (Enhanced & Optimized)
 ...
 */
contract MamaSaheliMilestoneNFT is ERC721, Ownable, Pausable /*, AccessControl */ {
    ...
    constructor(address initialOwner)
        ERC721("MamaSaheli Milestone Badge", "MCMB")
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory json = string(abi.encodePacked(
            '{',
                ...
                '"description": "A non-transferable MamaSaheli milestone badge. Achieved: ', milestoneName, ' Level ', info.level.toString(), '.",',
