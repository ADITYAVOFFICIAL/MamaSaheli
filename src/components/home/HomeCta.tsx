...
const HomeCta: React.FC = () => {
  return (
    ...
    <motion.section
      className="overflow-hidden bg-gradient-to-r from-mamasaheli-primary to-mamasaheli-dark py-20 text-white md:py-28"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          Start Your MamaSaheli Journey Today
        </motion.h2>
        ...
        <motion.p
          ...
          variants={itemVariants} // Apply item animation variants
        >
          Join thousands of expectant mothers and healthcare professionals using MamaSaheli for better pregnancy support and management.
        </motion.p>
        ...
        >
          ...
          <motion.div {...buttonMotionProps}>
            <Button
              ...
              className="rounded-lg bg-white px-8 py-3 text-base font-semibold text-mamasaheli-primary shadow-md transition-shadow duration-300 hover:bg-gray-100 hover:shadow-lg"
              asChild
            >
              <Link to="/signup">
          ...
          <motion.div {...buttonMotionProps}>
            <Button
              ...
              className="rounded-lg bg-mamasaheli-primary px-8 py-3 text-base font-semibold text-white shadow-md ring-1 ring-white/50 transition-all duration-300 hover:bg-mamasaheli-primary/90 hover:shadow-lg hover:ring-white/70"
              asChild
            >
