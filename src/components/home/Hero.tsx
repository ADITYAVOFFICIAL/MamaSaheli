    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none" aria-hidden="true">
        {backgroundHearts.map((heart, index) => (
          <Heart
            key={index}
            className={`absolute text-mamasaheli-accent dark:text-pink-500/50 animate-drift ${heart.size} ${heart.opacity}`}
            style={{
              top: heart.top,
              left: heart.left,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-mamasaheli-primary dark:text-mamasaheli-light tracking-tight leading-tight relative"
              variants={itemVariants}
            >
              Welcome to <span className="text-mamasaheli-accent dark:text-pink-400">MamaSaheli</span>
              <Heart className="absolute top-[-0.5rem] right-[5rem] md:right-[-1rem] lg:right-[-2rem] text-mamasaheli-accent opacity-15 dark:opacity-25 text-6xl md:text-8xl transform -rotate-12 pointer-events-none" aria-hidden="true" />
              <span className="absolute -top-10 right-58 text-mamasaheli-accent opacity-20 text-7xl font-bold">♡</span>
            </motion.h1>
            ...
            >
              <Button
                size="lg"
                className="bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-accent dark:hover:bg-pink-500 text-white font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 px-8 py-3 rounded-full group"
                asChild
              >
                <Link to="/chat">
