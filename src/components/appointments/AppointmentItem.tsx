...
const getAppointmentDisplayInfo = (appointmentType: string | undefined, propType: string | undefined) => {
    ...
    switch (effectiveType) {
        ...
        case 'fitness_class':
            return {
                Icon: GraduationCap,
                iconColor: 'text-mamasaheli-secondary', // Use secondary theme color
                bgColor: 'bg-mamasaheli-secondary/10',
        ...
        default: // Default to doctor type
            return {
                Icon: Stethoscope,
                iconColor: 'text-mamasaheli-primary', // Use primary theme color
                bgColor: 'bg-mamasaheli-primary/10',
      ...
      <CardContent className="p-4 flex items-center justify-between gap-x-4">
        ...
        <div className="flex min-w-0 items-start gap-x-3 flex-grow">
          ...
          <div className="min-w-0 flex-auto">
            <p className={`text-sm font-semibold leading-6 ${type === 'class' ? 'text-mamasaheli-secondary-dark' : 'text-mamasaheli-dark'}`}>
              {displayTitle}
            </p>
