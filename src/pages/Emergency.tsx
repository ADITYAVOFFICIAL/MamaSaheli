  ...
  const renderHospitalContent = () => {
      ...
      return (
        <div className="flex flex-col items-center justify-center text-center flex-grow py-10">
          ...
          <Button
            ...
            size="lg"
            className="bg-mamasaheli-primary hover:bg-mamasaheli-dark text-white"
          >
    ...
    switch (status) {
        ...
        case LoadingStatus.Locating:
          return ( <div className="flex flex-col items-center justify-center text-center flex-grow py-10"><Loader2 className="h-10 w-10 animate-spin text-mamasaheli-primary mb-4" /><p className="text-gray-600 font-medium">Getting your location...</p><p className="text-sm text-gray-500 mt-1">Please wait or allow location access.</p></div> );
        case LoadingStatus.LoadingMaps: // Show this if waiting for maps *after* button click
          return ( <div className="flex flex-col items-center justify-center text-center flex-grow py-10"><Loader2 className="h-10 w-10 animate-spin text-mamasaheli-primary mb-4" /><p className="text-gray-600 font-medium">Loading map services...</p></div> );
                    ...
                    <Card key={placeId || index} className="border border-gray-200 shadow-sm rounded-lg overflow-hidden transition-shadow hover:shadow-md">
                       <CardHeader className="p-4">
                         <div className="flex justify-between items-start gap-2">
                            <CardTitle className="text-base font-semibold text-mamasaheli-primary">{name || 'Hospital Name Unavailable'}</CardTitle>
                            {distanceKm !== null && (
                       ...
                       <div className="flex flex-wrap gap-2 items-center mb-2">
                             {isOpenNow !== undefined && (
                                <Badge
                                    ...
                                    className={`text-xs font-medium ${isOpenNow ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200 hover:text-green-900' : 'bg-red-100 text-red-800 border-red-200 hover:bg-mamasaheli-primary hover:text-white'}`}
                                >
                         ...
                         <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-600">
                            {phone && ( <a href={`tel:${phone}`} className="flex items-center hover:text-mamasaheli-primary hover:underline focus:outline-none focus:ring-1 focus:ring-mamasaheli-primary rounded"><PhoneCall className="h-3.5 w-3.5 mr-1" /> {phone}</a> )}
                            {website && ( <a href={website} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-mamasaheli-primary hover:underline focus:outline-none focus:ring-1 focus:ring-mamasaheli-primary rounded"><Globe className="h-3.5 w-3.5 mr-1" /> Website</a> )}
                         </div>
                       </CardContent>
                       <CardFooter className="p-4 bg-gray-50/70 border-t">
                           <Button asChild size="sm" className="bg-mamasaheli-primary hover:bg-mamasaheli-dark text-white" disabled={!placeId}>
        ...
        default:
             ...
             return <div className="flex flex-col items-center justify-center text-center flex-grow py-10"><Loader2 className="h-10 w-10 animate-spin text-mamasaheli-primary mb-4" /><p className="text-gray-600 font-medium">Initializing Search...</p></div>;
      }
  };
    ...
    <MainLayout>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-mamasaheli-primary sm:text-5xl tracking-tight">Emergency Support</h1>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <Card className="border-red-200 border shadow-lg rounded-lg overflow-hidden">
              ...
              <CardContent className="p-6 space-y-5">
                 ...
                 <div className="flex items-center justify-between border-b pb-4">
                    <div><h3 className="font-semibold text-gray-800 text-base">Pregnancy Support</h3><p className="text-lg font-bold text-mamasaheli-primary">0444-631-4300</p><p className="text-xs text-gray-500">(Check local availability)</p></div>
                    <Button asChild variant="outline" size="sm" className="border-mamasaheli-primary text-mamasaheli-primary hover:bg-mamasaheli-light hover:text-mamasaheli-primary"><a href="tel:04446314300" aria-label="Call Pregnancy Support Hotline"><HeartPulse className="mr-1.5 h-4 w-4" /> Call Support</a></Button>
                 </div>
                 <div>
        ...
        {/* Final CTA */}
        <div className="bg-gradient-to-r from-mamasaheli-light to-white rounded-lg p-8 text-center border border-mamasaheli-primary/20 shadow-md">
          <h2 className="text-2xl font-bold text-mamasaheli-primary mb-3">Have Non-Urgent Questions?</h2>
          ...
          <Button asChild size="lg" className="bg-mamasaheli-primary hover:bg-mamasaheli-dark text-base px-8 py-3"><a href="/chat">Chat with MamaSaheli</a></Button>
        </div>
      </div>
    </MainLayout>
  );
