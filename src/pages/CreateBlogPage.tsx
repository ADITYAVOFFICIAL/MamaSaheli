    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            const postData: CreateBlogPostData = {
                ...
                author: user.name || 'mamasaheli Admin', // Use logged-in user's name or a fallback
                category: category,
        ...
        <MainLayout>
            <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
                ...
                <div className="text-center mb-8 md:mb-12">
                    <h1 className="text-3xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light">Create New Blog Post</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">Share your knowledge and insights with the mamasaheli community.</p>
                </div>

                {/* Form Card */}
                <Card className="border-mamasaheli-primary/20 dark:border-gray-700/50 shadow-md">
                    <form onSubmit={handleSubmit} noValidate> {/* Add noValidate to rely on custom validation */}
                        <CardHeader>
                            <CardTitle className="text-xl text-mamasaheli-dark dark:text-gray-200">Post Details</CardTitle>
                        </CardHeader>
                        ...
                        <CardFooter className="flex justify-between items-center pt-6 border-t dark:border-gray-700">
                            ...
                            <Button
                                type="submit"
                                className="bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-primary dark:hover:bg-mamasaheli-dark min-w-[150px]" // Ensure minimum width
