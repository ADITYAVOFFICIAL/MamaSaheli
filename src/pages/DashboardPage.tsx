        ...
        <Card className="border border-gray-200 bg-white mt-4 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <CardHeader className="p-3 bg-gray-50 border-b dark:bg-gray-700/50 dark:border-gray-600">
                <CardTitle className="flex items-center text-gray-700 text-sm font-medium dark:text-gray-300">
                    <User className="mr-1.5 h-4 w-4 text-mamasaheli-primary" /> Profile & Activity
                </CardTitle>
            </CardHeader>
            <CardContent className="p-3 text-xs space-y-2 dark:text-gray-400">
                <div className="flex justify-between items-center">
                    ...
                    <span className={`font-semibold ${profileCompleteness === 0 ? "text-amber-500" : "text-mamasaheli-primary dark:text-mamasaheli-accent"}`}>{profileCompleteness}%</span>
                </div>
                <Progress value={profileCompleteness} className="h-1 [&>*]:bg-mamasaheli-primary dark:[&>*]:bg-mamasaheli-accent" aria-label={`Profile completeness: ${profileCompleteness}%`} />
                ...
                <div className="text-right pt-1">
                    <Button variant="link" size="sm" asChild className="text-xs h-auto p-0 text-mamasaheli-primary dark:text-mamasaheli-accent hover:underline">
                        ...
                        <div className="space-y-8 md:space-y-10">
                             ...
                             <Card className="border border-mamasaheli-secondary/30 shadow-sm bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-800 dark:via-gray-800/80 dark:to-gray-900/70 dark:border-gray-700">
                                <CardHeader className="pb-3">
                                    <div className="flex justify-between items-center">
                                        <CardTitle className="flex items-center text-mamasaheli-primary dark:text-mamasaheli-accent text-lg font-semibold">
                                    ...
                                    {isLoadingFeed ? (
                                        ...
                                        <div className="prose prose-sm dark:prose-invert max-w-none prose-p:my-1.5 prose-ul:my-1.5 prose-li:my-0.5 text-gray-700 dark:text-gray-300">
                                            <ReactMarkdown
                                                ...
                                                components={{
                                                    a: ({node, ...props}) => <a {...props} target="_blank" rel="noopener noreferrer" className="text-mamasaheli-secondary hover:underline" />,
                                                    strong: ({node, ...props}) => <strong className="font-semibold text-mamasaheli-dark dark:text-mamasaheli-light" {...props} />,
                                                }}
                                            >
                                                {dashboardFeedContent}
                                            </ReactMarkdown>
                                        ...
                                        {(currentWeek !== null && currentWeek >= 0) ? (
                                            <>
                                                <div>
                                                    ...
                                                    <Progress value={pregnancyProgress} className="h-2.5 [&>*]:bg-gradient-to-r [&>*]:from-mamasaheli-primary [&>*]:to-mamasaheli-secondary dark:[&>*]:from-mamasaheli-accent dark:[&>*]:to-pink-500" aria-label={`Pregnancy progress: ${pregnancyProgress}%`} />
                                        ...
                                        <CardContent className="pt-5 px-5">
                                             ...
                                             : nextDoctorAppointment ? (
                                                ...
                                                <div className="text-center py-4 flex flex-col items-center">
                                                    ...
                                                    <Button asChild size="sm" className="bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-accent dark:hover:bg-pink-700"><a href="/appointment">Schedule Visit</a></Button>
                                                </div>
                                             )}
                                        </CardContent>
                                    </Card>
                                            ...
                                            {isLoadingAppointments ? ( <div className="flex justify-center items-center py-4"><Loader2 className="h-6 w-6 animate-spin text-mamasaheli-secondary" /></div> )
                                             : nextClassAppointment ? (
                                                ...
                                                <div className="text-center py-4 flex flex-col items-center">
                                                    ...
                                                    <Button asChild size="sm" className="bg-mamasaheli-secondary hover:bg-mamasaheli-secondary/80 dark:bg-blue-500 dark:hover:bg-blue-600"><a href="/appointment">Schedule Class</a></Button>
                                                </div>
                                             )}
                                        </CardContent>
                                    </Card>
                                ...
                                <Card className="border border-gray-200 shadow-sm h-full bg-white dark:bg-gray-800 dark:border-gray-700">
                                     <CardHeader className="bg-gray-50 border-b border-gray-200 dark:bg-gray-700/50 dark:border-gray-600">
                                        <CardTitle className="flex items-center text-gray-700 dark:text-gray-300 text-lg font-semibold">
                                            <Activity className="mr-2 h-5 w-5 text-mamasaheli-primary" />Your Profile Summary
                                        </CardTitle>
                                    </CardHeader>
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 flex items-center">
                                        <BarChart3 className="mr-2 h-5 w-5 text-mamasaheli-accent" /> Health Readings Overview
                                    </h2>
                                     <Button variant="link" size="sm" asChild className="text-xs h-auto p-0 text-mamasaheli-accent hover:underline">
                                    ...
                                    <CardContent className="pt-6 px-5">
                                         <div className="space-y-4">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                ...
                                                <a href="/resources?category=Nutrition" className="block bg-white dark:bg-gray-700/30 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-md transition-shadow hover:border-mamasaheli-secondary/30 dark:hover:border-blue-400/30"><div className="flex items-center"><div className="flex-shrink-0 w-10 h-10 bg-mamasaheli-secondary/10 dark:bg-blue-500/10 rounded-full flex items-center justify-center mr-3"><Salad className="h-5 w-5 text-mamasaheli-secondary dark:text-blue-400" /></div><div><h3 className="font-semibold text-gray-800 dark:text-gray-200 text-sm">Diet & Nutrition</h3><p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Eating well for two</p></div></div></a>
                                                <a href="/blog/fetal-development-week-by-week" className="block bg-white dark:bg-gray-700/30 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-md transition-shadow hover:border-mamasaheli-accent/30 dark:hover:border-pink-400/30"><div className="flex items-center"><div className="flex-shrink-0 w-10 h-10 bg-mamasaheli-accent/10 dark:bg-pink-500/10 rounded-full flex items-center justify-center mr-3"><Baby className="h-5 w-5 text-mamasaheli-accent dark:text-pink-400" /></div><div><h3 className="font-semibold text-gray-800 dark:text-gray-200 text-sm">Baby Development</h3><p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Week-by-week guide</p></div></div></a>
                                            ...
                                            <div className="flex justify-center pt-2">
                                                <Button asChild variant="outline" size="sm" className="text-mamasaheli-primary border-mamasaheli-primary/50 hover:text-mamasaheli-dark hover:bg-mamasaheli-primary/5 dark:text-mamasaheli-light dark:border-mamasaheli-light/50 dark:hover:text-white dark:hover:bg-mamasaheli-light/10"><a href="/resources" className="flex items-center">Browse All Resources<ArrowRight className="ml-1.5 h-4 w-4" /></a></Button>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                            ...
                            <Card className="border border-gray-200 shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <CardContent>
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        ...
                                        <Button asChild variant="outline" className="h-24 flex flex-col justify-center items-center text-center p-2 border-gray-300 dark:border-gray-600 hover:bg-mamasaheli-light/50 dark:hover:bg-gray-700/50 hover:border-mamasaheli-primary/50 dark:hover:border-mamasaheli-light/50 group transition-all duration-150 ease-in-out hover:scale-105"><a href="/profile"><User className="h-6 w-6 mb-1.5 text-mamasaheli-primary dark:text-mamasaheli-light transition-transform group-hover:scale-110" /><span className="text-sm font-medium text-gray-700 dark:text-gray-300">My Profile</span></a></Button>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
