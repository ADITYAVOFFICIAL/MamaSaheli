  ...
  return (
    <MainLayout>
      ...
      <div className="container mx-auto px-4 py-8 relative">
        {/* Header Card */}
        <Card className="mb-8 border-mamasaheli-primary/20 shadow-lg">
            <CardHeader className="bg-mamasaheli-light dark:bg-black">
              <CardTitle className="text-2xl md:text-3xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light flex items-center">
            ...
            <CardContent className="pt-4 flex flex-col sm:flex-row justify-between items-center gap-4 flex-wrap">
               ...
               <Button
                ...
                className={`min-w-[170px] ${isConnected ? 'bg-red-600 hover:bg-red-700' : 'bg-mamasaheli-primary hover:bg-mamasaheli-dark'}`} // Red for disconnect
              >
                ...
                <CardTitle className="text-xl">Game Area</CardTitle>
                 <CardDescription>
                    ...
                    {lastReportedGameScore > 0 && !isSubmitting && isOnCorrectNetwork && (
                        <span className="ml-2 font-semibold text-mamasaheli-primary dark:text-mamasaheli-light">Last Score: {lastReportedGameScore}</span>
                    )}
                 </CardDescription>
              </CardHeader>
              ...
              <Card className="border-gray-300 dark:border-gray-700 shadow-sm">
                ...
                <CardContent className="text-center min-h-[60px] flex items-center justify-center">
                  {isLoadingData && highScore === '0' ? <Loader2 className="h-8 w-8 animate-spin text-gray-500 mx-auto" /> :
                   userAddress ? <p className="text-3xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light">{highScore}</p> :
