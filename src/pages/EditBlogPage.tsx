        ...
        return (
            <MainLayout>
                <div className="flex justify-center items-center h-[calc(100vh-10rem)]">
                    <Loader2 className="h-12 w-12 animate-spin text-mamasaheli-primary dark:text-mamasaheli-light" />
        ...
        <MainLayout>
            <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
                ...
                <div className="text-center mb-8 md:mb-12">
                    <h1 className="text-3xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light">Edit Blog Post</h1>
                ...
                <Card className="border-mamasaheli-primary/20 dark:border-gray-700/50 shadow-md">
                    ...
                    {originalPost && (
                        <form onSubmit={handleSubmit} noValidate>
                            <CardHeader>
                                <CardTitle className="text-xl text-mamasaheli-dark dark:text-gray-200">Edit Post Details</CardTitle>
                            </CardHeader>
                            ...
                            <CardFooter className="flex justify-between items-center pt-6 border-t dark:border-gray-700">
                                ...
                                <Button
                                    type="submit"
                                    className="bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-primary dark:hover:bg-mamasaheli-dark min-w-[150px]"
