    ...
    <MainLayout requireAuth={true}>
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-mamasaheli-primary">Medical Documents</h1>
        ...
        {/* Upload Card */}
        <Card className="border-mamasaheli-primary/20 mb-8">
          <CardHeader className="bg-mamasaheli-light">
            <CardTitle className="flex items-center text-mamasaheli-primary">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="cursor-pointer file:mr-4 file:py--1 file:px-4
                             ...
                             hover:file:bg-mamasaheli-primary/10"
                />
              ...
              {file && (
                <div className="bg-gray-50 p-3 rounded-md flex items-center justify-between border border-gray-200">
                  <div className="flex items-center space-x-2 overflow-hidden">
                    <FileText className="h-5 w-5 text-mamasaheli-primary flex-shrink-0" />
          ...
          <CardContent className="pt-6">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-8">
                <Loader2 className="h-8 w-8 text-mamasaheli-primary animate-spin mb-4" />
