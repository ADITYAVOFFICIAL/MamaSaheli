...
const ContactPage: React.FC = () => {
  ...
  return (
    ...
    <MainLayout requireAuth={false}>
      <div className="bg-gradient-to-b from-white via-mamasaheli-light/20 to-white dark:from-gray-900 dark:via-gray-800/20 dark:to-gray-900 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 md:gap-12 items-start">
            ...
            <div className="lg:col-span-3">
              <Card className="shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800">
                <CardHeader className="bg-gradient-to-r from-mamasaheli-light/50 to-white dark:from-gray-700/50 dark:to-gray-800 p-6 border-b dark:border-gray-700/50">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <CardFooter className="p-6 border-t dark:border-gray-700/50">
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full py-3 text-base bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-primary dark:hover:bg-mamasaheli-dark flex items-center justify-center gap-2"
                      disabled={isLoading}
                ...
                <CardContent className="p-6 space-y-5">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0 mt-1">
                      <AtSign className="h-5 w-5 text-mamasaheli-secondary dark:text-blue-400" />
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-gray-800 dark:text-gray-200">Email Us</h4>
                      <a href="mailto:support@mamasaheli.ai" className="text-sm text-mamasaheli-primary hover:text-mamasaheli-dark dark:text-mamasaheli-accent dark:hover:text-mamasaheli-light underline break-all">
                        support@mamasaheli.ai
                      </a>
                   ...
                   <div className="flex items-start space-x-3">
                     <div className="flex-shrink-0 mt-1">
                       <Phone className="h-5 w-5 text-mamasaheli-secondary dark:text-blue-400" />
                     </div>
                     <div>
                       <h4 className="text-sm font-medium text-gray-800 dark:text-gray-200">Call Us</h4>
                       <a href="tel:SAMPLE" className="text-sm text-mamasaheli-primary hover:text-mamasaheli-dark dark:text-mamasaheli-accent dark:hover:text-mamasaheli-light underline">
                         SAMPLE NUMBER
                       </a>
                   ...
                   <div className="flex items-start space-x-3">
                     <div className="flex-shrink-0 mt-1">
                       <MapPin className="h-5 w-5 text-mamasaheli-secondary dark:text-blue-400" />
                     </div>
                     <div>
                       ...
                       {/* <a href="#" target="_blank" rel="noopener noreferrer" className="text-xs text-mamasaheli-primary hover:underline dark:text-mamasaheli-accent">View on Map (Link)</a> */}
                     </div>
                   </div>
                   ...
                   <div className="flex items-start space-x-3">
                     <div className="flex-shrink-0 mt-1">
                       <Clock className="h-5 w-5 text-mamasaheli-secondary dark:text-blue-400" />
                     </div>
                     <div>
