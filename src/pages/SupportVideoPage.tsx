  ...
  const renderSelectionButton = (video: SupportVideoInfo): React.ReactNode => {
    ...
    const getVariantClass = () => {
      switch (video.buttonVariant) {
        case 'secondary':
          return 'bg-mamasaheli-secondary hover:bg-mamasaheli-secondary/90 text-white';
        case 'accent':
          return 'bg-mamasaheli-accent hover:bg-mamasaheli-accent/90 text-white'; // Ensure accent color is defined in tailwind.config
        case 'outline':
          return 'border-mamasaheli-primary/50 hover:text-mamasaheli-primary hover:bg-mamasaheli-primary/10';
        case 'default':
        default:
          return 'bg-mamasaheli-primary hover:bg-mamasaheli-dark text-white';
      }
    };
          ...
          {!selectedVideoInfo ? (
            ...
            >
              <motion.div variants={itemVariants}> {/* Animate icon */}
                <Film
                  className="mb-6 h-16 w-16 text-mamasaheli-primary/70 md:h-20 md:w-20"
                  strokeWidth={1.5}
                />
              </motion.div>
              <motion.h1
