            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8 pb-6 border-b dark:border-gray-700">
                    {patientProfile.profilePhotoUrl ? (
                        <img src={patientProfile.profilePhotoUrl} alt={patientProfile.name || 'Patient'} className="h-20 w-20 rounded-full object-cover border-2 border-mamasaheli-primary flex-shrink-0" />
                    ) : (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 items-start">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <Card className="shadow border dark:border-gray-700">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold flex items-center gap-2"><User className="h-5 w-5 text-mamasaheli-primary"/>Profile Information</CardTitle>
                            </CardHeader>
                        ...
                        <Card className="shadow border dark:border-gray-700">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold flex items-center gap-2"><HeartPulse className="h-5 w-5 text-mamasaheli-primary"/>Pregnancy Details</CardTitle>
                            </CardHeader>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card className="shadow border dark:border-gray-700">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold flex items-center gap-2"><CalendarDays className="h-5 w-5 text-mamasaheli-secondary"/>Appointments</CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card className="shadow border dark:border-gray-700">
                            <CardHeader>
                                <CardTitle className="text-lg font-semibold flex items-center gap-2"><BriefcaseMedical className="h-5 w-5 text-mamasaheli-accent"/>Medical Documents</CardTitle> {/* Changed Icon */}
                            </CardHeader>
                            <CardContent>
