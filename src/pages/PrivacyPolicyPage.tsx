          ...
          <Card className="shadow-lg border border-gray-200 rounded-lg overflow-hidden bg-white">
            ...
            <CardContent className="p-6 md:p-8 text-gray-700 leading-relaxed space-y-6">
              ...
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">1. Information We Collect</h2>
              ...
              {/* Section 2 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">2. How We Use Your Information</h2>
              ...
              {/* Section 3 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">3. How We Share Your Information</h2>
              ...
              {/* Section 4 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">4. Data Security</h2>
                <p className="text-sm">
              ...
              {/* Section 5 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">5. Data Retention</h2>
                 <p className="text-sm">
              ...
              {/* Section 6 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">6. Your Choices and Rights</h2>
                <p className="text-sm">
              ...
              {/* Section 7 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">7. Children's Privacy</h2>
                <p className="text-sm">
              ...
              {/* Section 8 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">8. Changes to This Privacy Policy</h2>
                <p className="text-sm">
              ...
              {/* Section 9 */}
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-mamasaheli-dark border-b pb-2">9. Contact Us</h2>
                <p className="text-sm">
                  If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:privacy@mamasaheli.ai" className="text-mamasaheli-primary hover:underline">privacy@mamasaheli.ai</a> (Replace with your actual privacy contact email).
                </p>
              </section>
