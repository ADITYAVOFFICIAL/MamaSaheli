            ...
            <TooltipProvider>
                <div className="container mx-auto max-w-6xl py-8 md:py-12 px-4">
                    ...
                    <div className="text-center mb-8 md:mb-12">
                         <h1 className="text-3xl md:text-4xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light tracking-tight">
                             MamaSaheli Milestones
                         </h1>
                         <p className="mt-3 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                             Celebrate your journey! Mint unique, non-transferable NFT badges on the <a href={MONAD_BLOCK_EXPLORER_URL} target="_blank" rel="noopener noreferrer" className="text-mamasaheli-secondary dark:text-blue-400 hover:underline">{MONAD_NETWORK_NAME}</a> for achieving key milestones.
                         </p>
                    </div>
                    ...
                    <Card className="mb-8 shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                         <CardHeader>
                             <CardTitle className="flex items-center text-xl font-semibold dark:text-gray-200">
                                 <Wallet className="mr-2 h-6 w-6 text-mamasaheli-secondary dark:text-blue-400" />
                                 Wallet Connection
                             </CardTitle>
                                                ...
                                                <Card key={typeId} className={`shadow-md border dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col transition-opacity duration-300 ${hasMintedThisType ? 'opacity-60' : milestone.enabled ? 'opacity-100' : 'opacity-40'} hover:shadow-lg`}>
                                                    <CardHeader className="pb-3">
                                                        <CardTitle className="flex items-center text-base font-semibold dark:text-gray-200">
                                                            <Icon className={`mr-2 h-5 w-5 flex-shrink-0 ${hasMintedThisType ? 'text-green-500' : 'text-mamasaheli-primary dark:text-mamasaheli-accent'}`} />
                                                    ...
                                                    <CardContent className="flex-grow flex flex-col justify-end space-y-2 pt-1">
                                                        ...
                                                        <Button
                                                            ...
                                                            className="w-full bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-accent dark:hover:bg-pink-700 disabled:opacity-50 disabled:cursor-not-allowed"
