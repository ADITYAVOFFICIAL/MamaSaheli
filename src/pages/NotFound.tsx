...
const NotFound = () => {
  ...
  return (
    ...
    <MainLayout>
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-150px)] px-4 py-12 bg-gradient-to-br from-gray-50 to-mamasaheli-light/30 text-center">
        {/* Adjust min-height based on your header/footer height */}

        <div className="max-w-md w-full">
          {/* Icon or Illustration */}
          <HelpCircle
            className="mx-auto h-20 w-20 text-mamasaheli-primary/50 mb-6"
            strokeWidth={1.5}
          />

          {/* Main Heading */}
          <h1 className="text-6xl font-extrabold text-mamasaheli-primary mb-3 tracking-tight">
            404
          </h1>
          ...
          <div className="space-y-4 sm:space-y-0 sm:flex sm:justify-center sm:space-x-4">
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto bg-mamasaheli-primary hover:bg-mamasaheli-dark"
            >
              <Link to="/">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-mamasaheli-primary/50 text-mamasaheli-primary hover:bg-mamasaheli-light/50 hover:text-mamasaheli-primary"
            >
              <Link to="/dashboard">
            ...
            {/* <Button variant="ghost" size="lg" className="w-full sm:w-auto text-gray-600 hover:text-mamasaheli-primary">
