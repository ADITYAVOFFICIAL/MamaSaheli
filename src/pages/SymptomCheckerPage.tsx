        ...
        <MainLayout requireAuth={true}>
            ...
            <div className="container mx-auto max-w-3xl py-8 md:py-12 px-4">
                <div className="text-center mb-8">
                    <h1 className="text-3xl md:text-4xl font-bold text-mamasaheli-primary tracking-tight">
                         ...
                         {!isLoadingProfile && (
                             <>
                                ...
                                <Button
                                    ...
                                    className="w-full md:w-auto bg-mamasaheli-primary hover:bg-mamasaheli-dark"
                                    aria-live="polite"
                                >
                                    {isLoadingResponse ? (
                                ...
                                <div className="prose prose-sm dark:prose-invert max-w-none prose-p:my-2 prose-ul:my-2 prose-li:my-0.5" aria-live="polite">
                                    <ReactMarkdown
                                        ...
                                        components={{
                                            ...
                                            blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-mamasaheli-primary/50 pl-4 italic text-gray-600 dark:text-gray-400" {...props} />,
                                        }}
                                    >
                                        {aiResponse}
                                    </ReactMarkdown>
