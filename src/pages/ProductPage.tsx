                                    ...
                                    <Card key={item.id} className="flex flex-col h-full border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden bg-white dark:bg-gray-800">
                                        <CardHeader className="p-4 pb-2">
                                            <div className="flex justify-between items-start gap-2">
                                                <CardTitle className="text-base font-semibold text-mamasaheli-primary dark:text-mamasaheli-light">{item.name}</CardTitle>
                                                {/* TODO: Apply category color helper if implemented */}
                                                {item.category && ( <Badge variant="secondary" className="text-xs font-semibold px-2.5 py-1 rounded-full bg-mamasaheli-light text-mamasaheli-dark tracking-wide hover:bg-mamasaheli-dark hover:text-mamasaheli-light"> {item.category} </Badge> )}
                                            </div>
                                        </CardHeader>
                                        <CardContent className="p-4 pt-1 flex-grow space-y-2">
                                        ...
                                        <CardFooter className="p-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                                            <Button asChild size="sm" className="flex-grow bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-primary dark:hover:bg-mamasaheli-dark text-white mr-2">
                                    ...
                                    <Card key={item.id} className="flex flex-col h-full border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden bg-white dark:bg-gray-800">
                                        <CardHeader className="p-4 pb-2">
                                            <div className="flex justify-between items-start gap-2">
                                                <CardTitle className="text-base font-semibold text-mamasaheli-primary dark:text-mamasaheli-light">{item.name}</CardTitle>
                                                 {/* TODO: Apply category color helper if implemented */}
                                                {item.category && ( <Badge variant="secondary" className="text-xs whitespace-nowrap capitalize text-mamasaheli-dark bg-mamasaheli-light tracking-wide hover:bg-mamasaheli-dark hover:text-mamasaheli-light px-2 py-0.5 rounded-full"> {item.category} </Badge> )}
                                            </div>
                                        </CardHeader>
                                        <CardContent className="p-4 pt-1 flex-grow space-y-2">
                                            <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3">{item.description}</p>
            ...
            <TooltipProvider delayDuration={100}>
                <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 sm:py-12">
                    ...
                    <div className="text-center mb-8 md:mb-12">
                        <h1 className="text-3xl md:text-4xl font-bold text-mamasaheli-primary dark:text-mamasaheli-light tracking-tight flex items-center justify-center gap-3">
                            <Sparkles className="w-7 h-7 text-mamasaheli-accent" />
                            AI Product Suggestions
                            <Package className="w-7 h-7 text-mamasaheli-secondary" />
                        </h1>
                    ...
                    <Card className="mb-8 border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800">
                        ...
                        <CardContent className="pt-6">
                            <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-4 items-end">
                                ...
                                <Button
                                    type="submit"
                                    className="w-full sm:w-auto bg-mamasaheli-primary hover:bg-mamasaheli-dark dark:bg-mamasaheli-primary dark:hover:bg-mamasaheli-dark"
