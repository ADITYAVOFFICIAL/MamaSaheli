...
// --- Constants ---
const FALLBACK_AUTHOR = 'mamasaheli Team'; // Default author name if not specified in post
            ...
            <div className="bg-gradient-to-b from-white to-mamasaheli-light/30 dark:from-gray-900 dark:to-gray-800/30">
                <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
                        ...
                        {isAdmin && (
                            <div className="flex gap-2">
                                ...
                                <Button
                                    ...
                                    className="border-mamasaheli-secondary text-mamasaheli-secondary hover:bg-mamasaheli-light hover:text-mamasaheli-dark dark:border-blue-400 dark:text-blue-400 dark:hover:bg-gray-700 dark:hover:text-blue-300"
                                >
                        ...
                        {post.category && (
                            ...
                            >
                                <Badge
                                    ...
                                    className="text-sm px-3 py-1 rounded-full bg-mamasaheli-light text-mamasaheli-primary group-hover:bg-mamasaheli-primary/20 transition-colors border border-mamasaheli-primary/30 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:group-hover:bg-gray-600"
                                >
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="prose lg:prose-lg dark:prose-invert max-w-none prose-img:rounded-lg prose-img:shadow-md prose-img:border prose-a:font-medium hover:prose-a:text-mamasaheli-accent dark:prose-a:text-blue-400 dark:hover:prose-a:text-blue-300">
                            <ReactMarkdown
                    ...
                    {post.tags && post.tags.length > 0 && (
                        <footer className="max-w-3xl mx-auto mt-12 pt-8 border-t border-mamasaheli-primary/20 dark:border-gray-700/50">
                            ...
                            <div className="flex flex-wrap gap-2" aria-label="Related tags">
                                {post.tags.map((tag) => (
                                    ...
                                    <Badge
                                        ...
                                        className="bg-mamasaheli-light text-mamasaheli-dark border border-mamasaheli-primary/20 hover:bg-mamasaheli-primary/20 transition-colors cursor-default dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600"
                                    >
                                        {tag}
                                    </Badge>
                                ))}
